...
def setup_training_run(description: str):
    ...
    curriculum = [
        ...
        CurriculumStage(name="Late Game",  state_factory=stage_late_game,  iterations=5000, simulations=400, temperature_cutoff = 12),
        CurriculumStage(name="Mid Game",   state_factory=stage_mid_game,   iterations=5000, simulations=800, temperature_cutoff = 18),
        CurriculumStage(name="Early Game", state_factory=stage_early_game, iterations=5000, simulations=800, temperature_cutoff = 24),
        CurriculumStage(name="Full Game",  state_factory=stage_full_game,  iterations=5000, simulations=800, temperature_cutoff = 30),
        CurriculumStage(name="Deep Game",  state_factory=stage_full_game,  iterations=1000, simulations=4000, temperature_cutoff = 36),
    ]
